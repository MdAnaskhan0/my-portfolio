    ...
    >
      ...
      >
        <div className="relative">
          ...
          <button 
            onClick={onClose}
            className="absolute top-4 right-4 bg-white/90 text-gray-800 rounded-full w-9 h-9 flex items-center justify-center hover:bg-white transition-colors shadow-md"
        ...
        <div className="p-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            <div>
              ...
              <span className="inline-block bg-indigo-100 text-indigo-800 text-sm px-3 py-1 rounded-md">
