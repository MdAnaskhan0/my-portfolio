  ...
  return (
    <div className="max-w-6xl mx-auto px-4">
      <div className="flex flex-col md:flex-col gap-8">
        ...
        {/* Experience */}
        <div className="bg-gray-900 sm:p-6">
          <div className="flex items-center mb-4">
            <div className="bg-gray-800 sm:p-3 rounded-full mr-4">
              <FiBriefcase className="text-yellow-600 text-xl" />
            </div>
            <h2 className="text-xl sm:text-2xl font-bold text-gray-100">Experience</h2>
          </div>
          <Experience />
        </div>
        ...
        <div className="bg-gray-900 sm:p-6">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-gray-100">Education</h2>
          </div>
          <Education />
        </div>
        ...
        <div className="bg-gray-900 sm:p-6">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-gray-100">Skills</h2>
          </div>
          <Skill />
        </div>
      </div>
